...
To validate our analytical model, we compare the results with HSPICE
...
which shows that the voltage drop on the selected cell derived from our
analytical model are consistent with the HSPICE simulation results.
\begin{figure}%[!t]
