...
can be found at Appendix. All of the KCL equations can be considered as a
system of linear equations, which has the following form
...
To validate our analytical model, we compare the results with the HSPICE
