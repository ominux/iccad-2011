...
area-efficient cross-point structure to build a ReRAM memory
array~\cite{memristor:Cong} without extra fabrication cost is enabled by
...
There are several write/read schemes for cross-point ReRAM array. For
