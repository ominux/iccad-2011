...
\end{enumerate}
%Since several potential read/write schemes can be used to program a memory
%array, it is difficult to identify the ideal scheme that meets the design
%constraints in terms of area, energy, and reliability.
