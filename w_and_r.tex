...
half-biased scheme. Howevern, compared to the total energy consumpion, the
...
average energy for one bit is therefore reduced. However, although
...
proportionally with its driving capability, the area overhead for multi-bit
