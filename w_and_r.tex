...
errors: \textbf{write failure} and \textbf{write disturbance}. All of the
...
any write failure and write disturbance even in the worst case.
...
The write failure results from the voltage drop at the interconnect
resistance along the word line and bit line. It has been shown that the
worst case of this scenario is:
\begin{equation}
\left\{
\begin{array}{l}
R_{i,j}=R_{on}\\
